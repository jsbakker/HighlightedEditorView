...
/// Tests that Cg syntax highlighting rules produce correct output.
struct CgHighlightTests {

    private func highlight(_ source: String) -> String {
        HighlightTestHelper.highlight(source, language: "cg")
    }

//
//  KotlinMultilineStringTests.swift
//  WebCppTests
//
...
/// Tests for triple-quoted multiline string highlighting in Kotlin.
/// Kotlin uses `/* */` block comments and `//` single-line comments.
struct KotlinMultilineStringTests {

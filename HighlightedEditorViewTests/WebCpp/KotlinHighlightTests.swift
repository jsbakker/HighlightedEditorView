...
/// Tests that Kotlin syntax highlighting rules produce correct output.
struct KotlinHighlightTests {

    private func highlight(_ source: String) -> String {
        HighlightTestHelper.highlight(source, language: "kt")
    }
    ...
    @Test func backtickStringsAreHighlighted() {
        // Kotlin uses backtick-escaped identifiers
        let html = highlight("`is`")

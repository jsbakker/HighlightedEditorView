//
//  JavaMultilineStringTests.swift
//  WebCppTests
//
...
/// Tests for triple-quoted multiline string highlighting in Java (text blocks, Java 13+).
/// Java uses `/* */` block comments and `//` single-line comments.
struct JavaMultilineStringTests {
